...
import #{groupId}.core.common.exception.PreviewException;
...
public class PreviewAspect {
    ...
    @Value("${#{projectName}.preview.enable:false}")
    private boolean isPreview = false;

    private final AntPathMatcher antPathMatcher = new AntPathMatcher();

    @Around(
            "execution(static #{groupId}.core.common.api.Result *(..)) || " +
