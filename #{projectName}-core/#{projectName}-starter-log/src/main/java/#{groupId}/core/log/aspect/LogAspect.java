package #{groupId}.core.log.aspect;
...
import #{groupId}.core.common.util.*;
import #{groupId}.core.log.annotation.Log;
import #{groupId}.core.log.event.LogEvent;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(#{groupId}.core.log.annotation.Log)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        .setTraceId(request.getHeader(MineConstant.CLOUD_TRACE_ID))
