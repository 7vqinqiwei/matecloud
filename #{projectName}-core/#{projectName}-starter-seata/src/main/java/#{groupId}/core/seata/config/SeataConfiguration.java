package #{groupId}.core.seata.config;
...
import #{groupId}.core.seata.props.SeataProperties;
 ...
 */
@Configuration
@PropertySource(factory = YamlPropertySourceFactory.class, value = "classpath:#{projectName}-seata.yml")
