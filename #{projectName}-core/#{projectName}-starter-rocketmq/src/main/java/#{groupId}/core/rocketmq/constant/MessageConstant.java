package #{groupId}.core.rocketmq.constant;
...
public class MessageConstant {
	 ...
	 * 生产者服务名称
	 */
	public static final String MESSAGE_PRODUCER_SERVICE = "#{projectName}-message-producer";

	/**
	 * 消费者服务名称
	 */
	public static final String MESSAGE_CONSUMER_SERVICE = "#{projectName}-message-consumer";
