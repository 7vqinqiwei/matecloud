package #{groupId}.core.jetcache.config;
 ...
 */
@Configuration
@EnableMethodCache(basePackages = "#{groupId}")
@EnableCreateCacheAnnotation
@PropertySource(factory = YamlPropertySourceFactory.class, value = "classpath:#{projectName}-jetcache.yml")
