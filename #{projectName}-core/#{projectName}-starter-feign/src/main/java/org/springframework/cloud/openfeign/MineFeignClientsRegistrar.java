...
import #{groupId}.core.feign.config.MineFeignAutoConfiguration;
 ...
 * @author L.cm
 */
public class MineFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return MineFeignAutoConfiguration.class;
    }
