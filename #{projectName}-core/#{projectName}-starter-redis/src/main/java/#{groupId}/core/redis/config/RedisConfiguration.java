package #{groupId}.core.redis.config;
...
import #{groupId}.core.redis.props.MineRedisProperties;
import #{groupId}.core.redis.core.RedisService;
import #{groupId}.core.redis.util.RedisLockUtil;
 ...
 */
@Configuration
@EnableConfigurationProperties(MineRedisProperties.class)
@ConditionalOnProperty(value = MineRedisProperties.PREFIX + ".enabled", havingValue = "true", matchIfMissing = true)
