...
import #{groupId}.core.web.props.MineSwaggerProperties;
...
@EnableConfigurationProperties(MineSwaggerProperties.class)
@PropertySource(factory = YamlPropertySourceFactory.class, value = "classpath:#{projectName}-swagger.yml")
public class SwaggerConfiguration implements WebMvcConfigurer {

    private final MineSwaggerProperties swaggerProperties;
    ...
    private ApiInfo groupApiInfo() {
        return new ApiInfoBuilder()
                ...
                .version(MineConstant.APP_VERSION)
                .build();
    }
    ...
    private List<ApiKey> securitySchemes() {
        ...
        apiKeyList.add(new ApiKey("#{ProjectName}-Auth", "#{ProjectName}-Auth", "header"));
        return apiKeyList;
    }
