 ...
 */
@Slf4j
public class MineSentinelInvocationHandler implements InvocationHandler {
	...
	MineSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MineSentinelInvocationHandler other = (MineSentinelInvocationHandler) obj;
