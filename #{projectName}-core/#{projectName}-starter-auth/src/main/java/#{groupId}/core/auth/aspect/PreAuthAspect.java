package #{groupId}.core.auth.aspect;
...
public class PreAuthAspect {
	...
	@Around("@annotation(#{groupId}.core.auth.annotation.PreAuth)")
	...
	public boolean hasPerm(String permission) {
		...
		Map<String, Object> data = (Map<String, Object>) redisService.get(Oauth2Constant.SYS_PERMISSION_PREFIX
