package #{groupId}.core.ide.aspect;
...
import #{groupId}.core.common.aspect.BaseAspect;
import #{groupId}.core.ide.annotation.Ide;
import #{groupId}.core.ide.enums.IdeTypeEnum;
import #{groupId}.core.ide.exception.IdeException;
...
public class IdeAspect extends BaseAspect {
	...
	@Pointcut("@annotation(#{groupId}.core.ide.annotation.Ide)")
