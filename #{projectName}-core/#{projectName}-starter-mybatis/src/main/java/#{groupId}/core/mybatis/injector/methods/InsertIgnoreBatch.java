...
package #{groupId}.core.mybatis.injector.methods;

import #{groupId}.core.mybatis.injector.MineSqlMethod;
...
public class InsertIgnoreBatch extends AbstractInsertBatch {
	...
	public InsertIgnoreBatch() {
		super(MineSqlMethod.INSERT_IGNORE_ONE.getSql(), SQL_METHOD);
	}
}
