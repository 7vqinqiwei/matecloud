...
public class Oauth2Constant {
	...
	public static final String SIGN_KEY = "#{projectName}";

	public static final String CAPTCHA_KEY = "#{projectName}captcha.";

	public static final String SMS_CODE_KEY = "#{projectName}sms.code.";
	...
	public static final String HEADER_TOKEN = "#{ProjectName}-Auth";

	/**
	 * 自定义client表名
	 */
	public static final String CLIENT_TABLE = "#{projectName}_sys_client";

	public static final String ENCRYPT = "{#{projectName}}";
	 ...
	 * 权限标识前缀
	 */
	public static final String SYS_PERMISSION_PREFIX = "#{projectName}permission.";
	 ...
	 * 用户头像
	 */
	public static final String SYS_USER_AVATAR = "avatar";

	/**
	 * 用户权限ID
	 */
	public static final String SYS_USER_ROLE_ID = "roleId";

	/**
	 * 用户类型
	 */
	public static final String SYS_USER_TYPE = "type";

	/**
	 * 租户ID
	 */
	public static final String SYS_TENANT_ID = "tenantId";
