...
public class MineConstant {
	 ...
	 * 微服务之间传递的唯一标识
	 */
	public static final String CLOUD_TRACE_ID = "cloud-trace-id";
	 ...
	 * 服务资源
	 */
	public static final String CLOUD_SERVICE_RESOURCE = "#{projectName}-service-resource";

	/**
	 * API资源
	 */
	public static final String CLOUD_API_RESOURCE = "#{projectName}-api-resource";

	/**
	 * 权限认证的排序
	 */
	public static final int UAA_FILTER_ORDER = -200;
	...
	public static final String CONFIG_DATA_ID_DYNAMIC_ROUTES = "#{projectName}-dynamic-routes.yaml";
