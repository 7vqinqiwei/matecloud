package #{groupId}.uaa.translator;
 ...
 */
@Slf4j
@Component("mineWebRespExceptionTranslator")
public class MineWebRespExceptionTranslator implements WebResponseExceptionTranslator {
